<template>
  <div class="tracking-page">
    ...
    <a-row>
      <a-col :span="8">
        <a-card title="基础信息" :bodyStyle="{ minHeight: '200px' }">
          <a-descriptions title="姓名：张三">
            <a-descriptions-item><img src="@/assets/keyFrameSample.jpg"
      ...
      <a-col :span="8">
        <a-card title="人员关系" :bodyStyle="{ minHeight: '450px' }">
      ...
      <a-col :span="8">
        <a-card title="历史总分" :bodyStyle="{ minHeight: '450px' }">
          <div class="radar-container">
            <GaugeChart />
          </div>
        </a-card>
    ...
    <a-row>
      <!-- 上半部分：折线图 -->
      <a-col :span="24">
        <a-card title="历史检测分数跟踪" :bodyStyle="{ height: '400px' }">
          <ColorLineChart />
        </a-card>
      </a-col>
    </a-row>
...
const fullText = '正在分析人员行为数据：根据近期的检测结果分析，该人员状态有波动，请立即人工介入'
let currentIndex = 0
